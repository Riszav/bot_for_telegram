...
async def my_profile_call(call: types.CallbackQuery):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=call.from_user.id,
            text='You don`t have profile. Please, register now'
        )
...
async def like_detect_call(call: types.CallbackQuery):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=call.from_user.id,
            text="You have already liked the profile"
        )
    finally:
        await call.message.delete()
...
# async def upgrade_profile(call: types.CallbackQuery):
#     db = Database()
#     # profile = db.sql_upgrade_user_form(
#     #     telegram_id=call.from_user.id
#     # )
